...
export default function AutofillCheckoutDemo({handleBlurEventAddress, handleChangeAddress, value}) {
...
useEffect(() => {
const accessToken = process.env.API_TOKEN || 'pk.eyJ1IjoicGF3YW51YmVyZSIsImEiOiJjbHBjcjAycmcwdXBxMmlwYnhyOXc1dm1kIn0.fgFN-kJzj5-brB2agdxX5A';
...
{/* Input form */}
<label className="txt-s txt-bold color-gray mb3">Address-2 example</label>
<AddressAutofill accessToken={token} onRetrieve={handleRetrieve}>
    <div className='d-flex'>
    <i className="icon border-right-0 border-0" id="icon-4"></i>

<input
className="input mb12 form-control py-3 border-0"
placeholder="Address with autosearch"
autoComplete="address-line1"
id="mapbox-autofill"
onChange={handleChangeAddress}
onBlur={handleBlurEventAddress}
value={value}
name={"address"}/>
